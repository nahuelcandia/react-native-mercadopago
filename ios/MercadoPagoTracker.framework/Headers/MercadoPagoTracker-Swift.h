...
SWIFT_CLASS("_TtC18MercadoPagoTracker13FlowTrackInfo")
@interface FlowTrackInfo : NSObject
@end


SWIFT_CLASS("_TtC18MercadoPagoTracker9GATracker")
@interface GATracker : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC18MercadoPagoTracker16PaymentTrackInfo")
...
SWIFT_CLASS("_TtC18MercadoPagoTracker14PaymentTracker")
